...
let tutorialEngineTwoText = [
    ...
    "Here is your abiltiies! it is represented by cards, there is a chance that they will turn against you. Click on the first card to select it.",
    "Once the ability is selected, you just need to use it on the enemy! BE CAREFUL, your weapon is your enemy: it can inflict damage on you !",
